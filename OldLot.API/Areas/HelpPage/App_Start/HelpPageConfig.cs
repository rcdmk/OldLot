...
namespace OldLot.API.Areas.HelpPage
{
    /// <summary>
    ...
    public static class HelpPageConfig
    {
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "OldLot.API.Areas.HelpPage.TextSample.#ctor(System.String)",
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            Type[] types = { typeof(VeiculoModel), typeof(FabricanteModel), typeof(TipoDeVeiculoModel) };
